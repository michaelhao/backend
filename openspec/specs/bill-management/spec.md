...
## Purpose
後台帳務管理（帳單建立與伺服端計價、列表搜尋分頁、明細 Modal、報價單 PDF、編輯帳務與狀態流轉、付款安裝、銷帳、未來生效排程）的完整行為規格。威脅模型：內部後台、非公網暴露（brute-force 不在 scope）、能登入後台者即為受信任的內部人員；正式環境無對外網際網路連線，本功能無任何外部呼叫。合併自舊版 `spec/13-bill-system.md` 與 2026-06-13 設計 review 修正（commit `3fc327a`、`6a17210`、`a9c8f73`、`0f046ca`、`47811a8`、`17508e1`、`5380364`、`f4e923b`）。
