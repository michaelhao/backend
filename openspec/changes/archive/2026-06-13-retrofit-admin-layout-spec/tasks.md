...
- [ ] 2.5 `openspec validate retrofit-admin-layout-spec` 通過後 archive，合併至 `openspec/specs/admin-layout/spec.md`

## 3. HTML 文件

- [ ] 3.1 從 spec.md 產生 `docs/admin-layout-spec.html`（單檔自包含、零外部資源，範本 `docs/auth-spec.html`）
